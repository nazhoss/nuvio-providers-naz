...
2. Add this repository URL:
   ```
   [https://raw.githubusercontent.com/yoruix/nuvio-providers/refs/heads/main/manifest.json](https://raw.githubusercontent.com/nazhoss/nuvio-providers-naz/refs/heads/main/manifest.json)
   ```
